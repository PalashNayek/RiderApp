package com.example.hp.googlemap.cardImageList;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public ImageAdapter(ArrayList<ImageModal> imageCardArrayList, Context context) {
    ...
    public ImageAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_type_list, parent, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView card_num;
        ArrayList<ImageModal> imageCardArrayList;
        Context context;

        public ImageViewHolder(View itemView, Context context, ArrayList<ImageModal> imageCardArrayList) {
