...
public class PinOnMapActivity extends AppCompatActivity
{
    TextView placeNameText,placeAddressText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPlaceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Intent intent=builder.build(PinOnMapActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode)
        {
            case MY_PERMISSION_FINE_LOCATION:
                ...
                {
                    Toast.makeText(this, "This app requires location permissions to granted", Toast.LENGTH_SHORT).show();
                    finish();
                }
                break;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==PLACE_PICKER_REQUEST)
        {
            ...
            {
                Place place=PlacePicker.getPlace(PinOnMapActivity.this,data);
